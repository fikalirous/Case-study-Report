...
1) customers.csv contain following features:
...
2) sellers.csv contains following features:
...
3) order_items.csv contain following features:
...
4) geolocations.csv contain following features:
...
5) orders.csv contain following features:
...
6) reviews.csv contain following features:
...
7) products.csv contain following features:
...
Problem Statement which need to be answered:
